...
public class SrrService {
    ...
    public List<Match> generateSrrRound(String tournamentId, String format, int roundNumber, String venueName) {
        ...
        List<Match> existingMatches = matchRepository.findActiveByTournamentIdAndFormatOrderByRoundNumberAscBoardNumberAsc(tournamentId, format)
                .stream()
    ...
    public List<Standing> calculateStandings(String tournamentId, String format) {
        ...
        List<Match> matches = matchRepository.findActiveByTournamentIdAndFormatOrderByRoundNumberAscBoardNumberAsc(tournamentId, format);
        for (Match m : matches) {
    ...
    private Set<String> existingPairs(String tournamentId, String format) {
        return matchRepository.findActiveByTournamentIdAndFormatOrderByRoundNumberAscBoardNumberAsc(tournamentId, format)
                .stream()
                .filter(m -> "SRR".equalsIgnoreCase(m.getRoundType()))
